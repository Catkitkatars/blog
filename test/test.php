...
$sql_create_post_table = "CREATE TABLE post_table (
...
$sql_insert_post_table = "INSERT INTO `post_table` (`post_name`, `post_text`, `user_name`, `date_create`) 
...
libero aspernatur optio corrupti voluptates, doloribus omnis, assumenda voluptate mollitia, fuga delectus explicabo distinctio. Aspernatur ut,
 provident iste deleniti enim consequuntur fugiat laboriosam, officia officiis, natus nobis maxime optio excepturi mollitia?', 'Bobby', '$now')";


$sql_select_all_post_table = "SELECT * FROM `post_table`";
...
// $db->query($sql_create_users_table);
// $db->query($sql_insert_user_in_users_table);
$result = $db->query($sql_select_from_date);
